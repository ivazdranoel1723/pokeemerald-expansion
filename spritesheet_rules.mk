...
$(OBJEVENTGFXDIR)/misc/briefcase.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
...
$(OBJEVENTGFXDIR)/pokemon/surfable/shellos_West.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
	
$(OBJEVENTGFXDIR)/pokemon/surfable/shellos.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
	
$(OBJEVENTGFXDIR)/pokemon/surfable/gastrodon_West.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
	
$(OBJEVENTGFXDIR)/pokemon/surfable/gastrodon.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
