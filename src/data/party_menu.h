...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_CHANGE_ABILITY]  = {COMPOUND_STRING("Change Ability"),  CursorCb_ChangeAbility},
        // Start hexorb branch
    [MENU_INFLICT_SLEEP] = {gText_Sleep, TryHexorbAndPrintResult},
    [MENU_INFLICT_POISON] = {gText_Poison, TryHexorbAndPrintResult},
    [MENU_INFLICT_BURN] = {gText_Burn, TryHexorbAndPrintResult},
#if B_USE_FROSTBITE == TRUE
    [MENU_INFLICT_FREEZE_FROSTBITE] = {gText_Frostbite, TryHexorbAndPrintResult},
#else
    [MENU_INFLICT_FREEZE_FROSTBITE] = {gText_Ice, TryHexorbAndPrintResult},
#endif
    [MENU_INFLICT_PARALYSIS] = {gText_Paralysis, TryHexorbAndPrintResult},
// End Hexorb branch
};
...
#define ROTOM_SOUND_MOVE   MOVE_BOOMBURST
